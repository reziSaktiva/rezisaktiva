...
/**
 * rezisaktiva theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { rezisaktivaTheme } from './rezisaktiva';
 *   import './rezisaktiva.css';
 */
export const rezisaktivaTheme = {
  name: 'rezisaktiva',
  __built: true,
  tokens: {
    ...
    "--color-background-surface": "light-dark(#edeae1, #0a0f1a)",
    "--color-background-body": "light-dark(#edeae1, #0a0f1a)",
    "--color-background-card": "light-dark(#edeae1, #0a0f1a)",
    "--color-background-popover": "light-dark(#e4dfd1, #121a2b)",
    "--color-background-muted": "light-dark(#e4dfd1, #121a2b)",
    "--color-accent": "light-dark(#4c7a73, #7fb3aa)",
    "--color-accent-muted": "light-dark(#d8e2de, #1e302e)",
    ...
    "--color-text-primary": "light-dark(#14181f, #edeae1)",
    "--color-text-secondary": "light-dark(#6e6a5f, #9b968a)",
    "--color-text-disabled": "light-dark(#a3a3a3, #525252)",
    "--color-text-accent": "light-dark(#4c7a73, #7fb3aa)",
    "--color-on-dark": "#edeae1",
    "--color-on-light": "#14181f",
    "--color-on-accent": "light-dark(#edeae1, #0a0f1a)",
    "--color-on-success": "light-dark(#ffffff, #171717)",
    "--color-on-error": "light-dark(#ffffff, #171717)",
    "--color-on-warning": "#171717",
    "--color-icon-accent": "light-dark(#4c7a73, #7fb3aa)",
    "--color-icon-primary": "light-dark(#14181f, #edeae1)",
    "--color-icon-secondary": "light-dark(#6e6a5f, #9b968a)",
    ...
    "--color-border": "light-dark(#dad5c7, #222b3d)",
    "--color-border-emphasized": "light-dark(#dad5c7, #222b3d)",
    ...
    "--color-background-inverted": "light-dark(#0a0f1a, #edeae1)"
  },
