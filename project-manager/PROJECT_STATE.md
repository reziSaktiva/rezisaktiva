...
* **Active Mode:** Validation — **T-042.4** ✅ Workflow decision-driven (ADR-042); **T-053** ✅ pita footer Home (ADR-041); **T-052** ✅ About = section Home (ADR-040); **T-042.1–T-042.3** ⏳; **T-043** setelah T-042; **T-031** ⏸️; bukan R2 tanpa ADR
* **Top Next Tasks:** **T-042.1–T-042.3** ⏳; **T-043** ⏳ — lihat [`TASKS.md`](TASKS.md)
* **Blocker:** Tidak ada
...
* Fase aktif: **Validation**. **T-042.4** ✅ Workflow decision-driven (**ADR-042**). **T-053** ✅ pita footer di Home (ADR-041). **T-052** ✅ About = section `#about` di Home (ADR-040). **T-042.1–T-042.3** ⏳. **T-043** setelah T-042. **T-031** ⏸️.
...
* **T-038…T-043** identitas visual (kulit saja, ADR-029) — Q&A per permukaan lalu kode; **bukan** tulis ulang copy kecuali **T-046…T-048** dan **isi `/workflow` (ADR-042)**; IA Home mengikuti **ADR-032** + **ADR-037** + **ADR-038** (lede + h1 dua baris, Now di About) dan **ADR-041** (pita footer di Home setelah `#about`); About vs Workflow mengikuti **ADR-035**; permukaan Workflow mengikuti **ADR-042**
