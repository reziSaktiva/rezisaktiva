...
* **Top Next Tasks:** copy teks **T-021** (diskusi, mulai T-021.2 Home) + UI **T-014** (Home + work teaser); **T-020** masuk backlog — lihat [`TASKS.md`](TASKS.md)
* **Blocker:** Tidak ada
...
* Backlog Development R1 **sudah disusun** (`tasks/v03-development-r1.md`, T-013…T-020). **Copy semua teks R1** di `tasks/v10-page-copy.md` (**T-021**, diskusi dengan Boss Rezi — jangan mengarang). Nomor v01–v06 tetap untuk urutan rilis yang direncanakan; copy memakai **v10**. **T-013 selesai penuh (T-013.1–T-013.4)**. Berikutnya: **T-021.2** (teks Home) + **T-014** (Home + work teaser). **T-020** masuk backlog UI.
