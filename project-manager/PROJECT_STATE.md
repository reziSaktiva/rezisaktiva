...
ADR terbaru: **ADR-022** (modul baru M13 Quick Info panel — overlay global, bukan route; exclude Work case) dan **ADR-023** (tambahan M3 Contact — tautan unduh CV/Portofolio di modal yang sudah ada; bukan route baru; implementasi ditunda ke T-023 menunggu CV Inggris). Indeks lengkap ADR-001…ADR-023: lihat [`DECISIONS.md`](DECISIONS.md).
