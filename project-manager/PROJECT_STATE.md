...
* **Active Mode:** Validation — **T-045** ✅ (About ↔ Workflow, ADR-035); **prioritas T-042** halaman (Home = hero-only, ADR-032 / tanpa footer, ADR-033; About vs Workflow); **T-044** ✅; **T-041** ✅; **T-040** ✅ (selected = outline ADR-031); **T-039** ✅; **T-038** ✅; **T-043** setelah T-042; **T-031** ⏸️ sampai gelombang v15 (token sudah); **T-032…T-037** ✅; T-023 bila aset CV Inggris siap; bukan R2 tanpa ADR
...
* Fase aktif: **Validation** — buktikan clarity + soft path inbound (bukan volume outreach). **T-045** ✅ (About ↔ Workflow, ADR-035). **T-044** ✅ (Home hero-only, ADR-032). **Prioritas: T-042** ⏳ halaman. **T-041** ✅. **T-040** ✅. **T-039** ✅. **T-038** ✅. **T-043** setelah T-042. **T-031** ⏸️ sampai T-043. **T-032…T-037** ✅ (v14 Done, ADR-028). **T-023** ⏸️ CV Inggris. **T-030** ✅. **T-029** ✅. **T-028** ✅.
...
* **T-038…T-043** identitas visual (kulit saja, ADR-029) — Q&A per permukaan lalu kode; **bukan** tulis ulang copy; IA Home mengikuti **ADR-032** (hero-only) dan **ADR-033** (tanpa pita footer); About vs Workflow mengikuti **ADR-035**
