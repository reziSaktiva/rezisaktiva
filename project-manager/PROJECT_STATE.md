...
* **Active Mode:** Validation — **T-052** ✅ About = section Home (ADR-040); **T-042** ⏳; **T-043** setelah T-042; **T-031** ⏸️; bukan R2 tanpa ADR
...
* **Backlog task lengkap:** [`TASKS.md`](TASKS.md) + `tasks/v18-about-home-section.md` (⏳ **T-052**, ADR-040); rilis v01–v17 tetap di `TASKS.md`
...
* Fase aktif: **Validation**. **T-052** ✅ About = section `#about` di Home (ADR-040). **T-042** kulit halaman masih ⏳. **T-043** setelah T-042. **T-031** ⏸️.
