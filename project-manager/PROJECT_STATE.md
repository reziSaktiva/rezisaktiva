...
* **Top Next Tasks:** **T-032** ✅; lanjut **T-033**; **T-031** ⏳ antrian; **T-023** ⏸️ — lihat [`TASKS.md`](TASKS.md)
* **Blocker:** Tidak ada
...
* Fase aktif: **Validation** — buktikan clarity + soft path inbound (bukan volume outreach). **Prioritas: T-033…T-037** ⏳ migrasi shadcn (ADR-028). **T-032** ✅. **T-031** ⏳ antrian setelah T-037. **T-023** ⏸️ CV Inggris. **T-030** ✅. **T-029** ✅. **T-028** ✅.
