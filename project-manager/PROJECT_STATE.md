...
* **Active Mode:** Validation — **prioritas T-042** halaman; **T-041** ✅; **T-040** ✅ (selected = outline ADR-031); **T-039** ✅; **T-038** ✅; **T-043** setelah T-042; **T-031** ⏸️ sampai gelombang v15 (token sudah); **T-032…T-037** ✅; T-023 bila aset CV Inggris siap; bukan R2 tanpa ADR
...
ADR terbaru: **ADR-031** (selected chrome = outline darah + teks aksen; ADR-030 superseded). **ADR-029** tetap untuk identitas gothic-blood. ADR-028 tetap untuk stack shadcn + Tailwind. Indeks: [`DECISIONS.md`](DECISIONS.md).
