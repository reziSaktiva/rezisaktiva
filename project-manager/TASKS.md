...
1. Copy teks di **v10** (`tasks/v10-page-copy.md`, **T-021**) — **T-021.2** (Home) hampir selesai (teaser menunggu daftar karya); **T-021.5** daftar karya kurasi ✅ terkunci (8 item dari resume), `h1`/lead/CTA Work index masih draf. Berikutnya: kunci Work index lalu T-021.1/T-021.3/T-021.4/T-021.6/T-021.7.
...
| v10 Page copy R1 | [`tasks/v10-page-copy.md`](tasks/v10-page-copy.md) | T-021 | ⏳ In Progress (T-021.2 hampir selesai, T-021.5 daftar karya ✅) |
