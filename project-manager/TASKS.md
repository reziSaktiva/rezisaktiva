...
1. Copy teks di **v10** (`tasks/v10-page-copy.md`, **T-021**) — **T-021.2** (Home) hampir selesai (sisa teaser); **T-021.1**, **T-021.3**, **T-021.4**, **T-021.5** ✅. Sisa: T-021.6 (Quick Info) / T-021.7 (meta).
