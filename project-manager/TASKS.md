...
6. **KI-001 / KI-002** tertutup (tema `rezisaktiva` = mockup `shared.css`).
...
| v0.3 Development R1 | [`tasks/v03-development-r1.md`](tasks/v03-development-r1.md) | T-013 … T-020, T-022, **T-024** | ⏳ In Progress (T-013…T-017 ✅, T-019 ✅, T-020 ✅, **T-022** ✅, **T-024** ✅; T-018 ⏳ menunggu T-021) |
