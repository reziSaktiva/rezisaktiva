...
1. **T-032 … T-037** — Migrasi Astryx → shadcn/ui + Tailwind v4 ⏳ **prioritas** (ADR-028). **T-032.1–T-032.4** ✅. Lanjut **T-032.5**. Detail: [`tasks/v14-shadcn-tailwind.md`](tasks/v14-shadcn-tailwind.md).
