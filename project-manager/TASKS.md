...
1. **T-032 … T-037** — Migrasi Astryx → shadcn/ui + Tailwind v4 ⏳ **prioritas** (ADR-028). **T-032** ✅. **T-033** ✅ (T-033.1–T-033.7). **T-034** ✅ (T-034.1–T-034.5). **T-035** ✅ (T-035.1–T-035.5). **T-036** ✅ (T-036.1–T-036.6). **T-037** ⏳ (**T-037.1–T-037.3** ✅; berikutnya **T-037.4**). Detail: [`tasks/v14-shadcn-tailwind.md`](tasks/v14-shadcn-tailwind.md).
