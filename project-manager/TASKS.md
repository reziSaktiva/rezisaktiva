...
1. Copy teks di **v10** (`tasks/v10-page-copy.md`, **T-021**) — **T-021.2** (Home) hampir selesai (teaser menunggu daftar karya); **T-021.1**, **T-021.3**, **T-021.4**, **T-021.5** ✅ selesai. Berikutnya: T-021.6 (Quick Info) / T-021.7 (meta).
...
6. **T-025** — craft Hess/Mazur (ADR-025) ⏳ In Progress (T-025.1–T-025.8 ✅; **T-025.9** scrollbar bertema — open). Detail: [`tasks/v03-development-r1.md`](tasks/v03-development-r1.md). Boleh paralel dengan T-021.6/T-021.7.
...
| v0.3 Development R1 | [`tasks/v03-development-r1.md`](tasks/v03-development-r1.md) | T-013 … T-020, T-022, T-024, **T-025** | ⏳ In Progress (T-013…T-017 ✅, T-019 ✅, T-020 ✅, **T-022** ✅, **T-024** ✅, **T-025** ⏳ T-025.9; T-018 ⏳ menunggu T-021) |
