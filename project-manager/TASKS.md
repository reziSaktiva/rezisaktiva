...
1. **T-032 … T-037** — Migrasi Astryx → shadcn/ui + Tailwind v4 ⏳ **prioritas** (ADR-028). **T-032** ✅. **T-033** ✅ (T-033.1–T-033.7). **T-034** ✅ (T-034.1–T-034.5). Lanjut **T-035**. Detail: [`tasks/v14-shadcn-tailwind.md`](tasks/v14-shadcn-tailwind.md).
