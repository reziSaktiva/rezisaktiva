...
1. **T-029** — JSON-LD schema.org dari `content/` ⏳ (T-029.1–T-029.4). Detail: [`tasks/v11-structured-data.md`](tasks/v11-structured-data.md).
2. **T-030** — SEO R1 (sitemap/robots/lang, CWV ukur, hygiene on-page, ops GSC) ⏳ (T-030.1–T-030.4). Detail: [`tasks/v12-seo.md`](tasks/v12-seo.md).
...
| v11 Structured data | [`tasks/v11-structured-data.md`](tasks/v11-structured-data.md) | T-029 | ⏳ Open |
| v12 SEO | [`tasks/v12-seo.md`](tasks/v12-seo.md) | T-030 | ⏳ Open |
