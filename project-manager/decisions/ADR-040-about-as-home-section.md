...
3. **Section bukti AI (`#proof`) dicabut.** Copy T-021.2 tidak tampil di UI. **Pita Contact tidak** di Home (ADR-033 tetap); About sebagai section tidak punya footer sendiri.
