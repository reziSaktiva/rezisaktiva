...
1. **Halaman `/[locale]/about` adalah About pribadi (M2).** Isi: hero (sapaan, lead, potret, availability, workplace) + klaim bukti AI (`#proof`, T-021.2 / ADR-032). Label chrome: **Tentang** (`id`) / **About** (`en`).
...
- Docs: IA, nav, key screens, M2/M14, MVP. Task **T-045**. **T-042.2** About = hero + bukti; **T-042.4** Workflow.
