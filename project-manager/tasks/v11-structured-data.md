...
6. **Foto.** `Person.image` **jangan diisi** selama potret About masih placeholder Unsplash (Google: jangan markup gambar default/placeholder). Home tidak menampilkan foto diri. Nyala setelah aset foto nyata di About.
