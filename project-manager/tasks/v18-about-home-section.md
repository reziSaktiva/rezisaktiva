...
Release IA: About bukan halaman. Chip nav tetap. **T-052**. **ADR-040**.
...
* **Output:** Home = hero + About; `/about` redirect; chip Tentang/About aktif di `#about`; tanpa `#proof`; Home tanpa pita Contact
* **Baca dulu:** ADR-040, ADR-039, ADR-033, ADR-038, `home-page.tsx`, `about-page.tsx`, `lib/nav.ts`
