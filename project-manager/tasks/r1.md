...
- [x] **T-042.3** — Q&A + kode: Work index + tile. Klik tetap buka sheet T-041.3. Verifikasi rute, tema gelap yang di-ship, 320 / 375 / desktop. **Dikunci chat 2026-09-08:** semua tile = pelat museum (mat + hairline luar seperti About). **Dikunci chat 2026-09-15:** hover desktop = grayscale → warna penuh + scale foto + caption (bukan blood drip; kunci drip 2026-09-04 dicabut). Ponsel (`hover: none`) = warna penuh.
