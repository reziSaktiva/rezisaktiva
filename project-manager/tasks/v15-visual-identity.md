...
- About: hero + **Now** + potret 4:5 + **bukti AI** (tanpa offers/proses — ADR-035)
...
- [ ] **T-042.2** — Q&A + kode: About (h1 + potret 4:5, **Now** `#now`, **bukti AI setelah hero** — ADR-035 / ADR-037; tanpa offers/proses). Copy tidak dipotong.
