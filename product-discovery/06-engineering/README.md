...
Acuan fase: Next.js single-app + pnpm; Vercel; CI Actions lint/typecheck; ESLint/Prettier; shadcn/ui + Tailwind CSS v4 (dark default, light hold via `html.dark` — **ADR-028** / **ADR-021** update T-038.2; ADR-018 superseded).
