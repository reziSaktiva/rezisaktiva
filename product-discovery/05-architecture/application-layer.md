...
> **Update (2026-08-15/16, ADR-019/ADR-020; 2026-09-07, ADR-035; 2026-09-08, ADR-040; 2026-09-14, ADR-044):** Route halaman = Home (termasuk `#about`), Workflow (`/workflow`), Work index (`/projects`), **Work case (`/projects/[slug]`, R2)**. `/about` redirect ke `#about`. Contact **bukan** route. Sheet M10 tetap overlay.
...
| Entry | Perilaku |
| ----- | -------- |
| `/[id\|en]/`, `/[id\|en]/workflow`, `/[id\|en]/projects`, `/[id\|en]/projects/[slug]` | Sajikan halaman yang di-build untuk locale itu |
