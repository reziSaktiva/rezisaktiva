...
/** Chrome theme toggle — path sama dengan ikon sun/moon produksi sebelumnya. */
...
/** About process steps (T-025.4) — ikon per langkah, bukan foto stok. */
