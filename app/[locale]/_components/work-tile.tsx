 ...
 * `hover: none` (ponsel). Hover desktop = grayscale → warna penuh,
 * foto sedikit membesar di dalam plate + caption. Reduced-motion =
 * tanpa scale; warna tetap berubah instan.
 */
